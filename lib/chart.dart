...
class LineChartSample6 extends StatelessWidget {
  static double _numRandom1 = new Random().nextInt(6).toDouble();
  static double _numRandom2 = new Random().nextInt(6).toDouble(); 
  static double _numRandom3 = new Random().nextInt(6).toDouble(); 
  static double _numRandom4 = new Random().nextInt(6).toDouble(); 
  static double _numRandom5 = new Random().nextInt(6).toDouble();  
  static double _numRandom6 = new Random().nextInt(6).toDouble(); 
  static double _numRandom7 = new Random().nextInt(6).toDouble(); 
  static double _numRandom8 = new Random().nextInt(6).toDouble(); 

  final spots = [
    FlSpot(0, _numRandom1),
    FlSpot(2, _numRandom2),
    FlSpot(4, _numRandom3),
    FlSpot(6, _numRandom4),
  ];

  final spots2 = [
    FlSpot(0, _numRandom5),
    FlSpot(2, _numRandom6),
    FlSpot(4, _numRandom7),
    FlSpot(6, _numRandom8),
  ];
